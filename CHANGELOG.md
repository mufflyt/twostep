...
| whether the workforce panel is temporally correct                   | [`docs/APPENDIX_COHORT_TEMPORAL_INTEGRITY.md`](https://mufflyt.github.io/twostep/docs/APPENDIX_COHORT_TEMPORAL_INTEGRITY.md)        |
