...
[`tools/ci/release_audit.sh`](../tools/ci/release_audit.sh) runs all twenty-three
...
It does not stop on first failure, deliberately — learning twenty-three failures one
...
...
AUDIT VERDICT: ALL 23 GATES PASS
```
